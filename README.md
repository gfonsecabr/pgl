...
| 2-dimensional | [`Halfplane`](doc/shapes.md#half-plane), [`Triangle`](doc/shapes.md#triangle), [`Rectangle`](doc/shapes.md#rectangle), [`Disk`](doc/shapes.md#disk), [`Convex`](doc/shapes.md#convex), [`Polygon`](doc/shapes.md#polygon), [`PolygonWithHoles`](doc/shapes.md#polygon-with-holes), [`HalfplaneIntersection`](doc/shapes.md#halfplane-intersection) |
