...
| Point search, count in Triangle | ${\color{#8b0000}\textsf{2.3×}}\textsf{ (1.5–2.7)}$ | ${\color{#006400}\textsf{0.21×}}\textsf{ (0.13–0.24)}$ | `ShapeTree` | `Kd_tree::search` |
...
| Convex hull | ${\color{#8b0000}\textsf{1.6×}}\textsf{ (1.5–1.8)}$ | ${\color{#006400}\textsf{0.47×}}\textsf{ (0.40–0.54)}$ | `convexHull(v)` | `convex_hull_2` |
...
| kd-tree build | $\textsf{0.93×}\textsf{ (0.87–0.99)}$ | ${\color{#8b0000}\textsf{2.0×}}\textsf{ (1.9–2.2)}$ | `ShapeTree` | `Kd_tree` |
...
| Nearest neighbor query | ${\color{#006400}\textsf{0.67×}}\textsf{ (0.63–0.70)}$ | ${\color{#8b0000}\textsf{1.5×}}\textsf{ (1.2–1.6)}$ | `t.nearestNeighbor(p)`{ShapeTree} | <code>Orthogonal_k_<wbr>neighbor_search</code> |
