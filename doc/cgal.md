...
| --- | --- | --- | --- | --- |
| Segment search, count in Rectangle | 39× (29–42) | 1.3× (0.72–1.4) | [`IntervalTree`](https://gfonsecabr.github.io/pgl/classpgl_1_1IntervalTree.html "Mutable interval tree over the projection of bounded shapes."), [`ShapeTree`](https://gfonsecabr.github.io/pgl/classpgl_1_1ShapeTree.html "Static shape tree of bounded shapes.") | `AABB_tree` |
| Segment search, count in Triangle | 24× (14–24) | 0.81× (0.52–0.86) | [`ShapeTree`](https://gfonsecabr.github.io/pgl/classpgl_1_1ShapeTree.html "Static shape tree of bounded shapes.") | `AABB_tree` |
...
| Triangulation point location | 2.7× (1.8–3.1) | 1.6× (1.2–2.8) | [`t.locate(p)`](https://gfonsecabr.github.io/pgl/structpgl_1_1Triangulation.html#a29b96c32ebb52fddc7fd10eaeee4dbd8 "Finds the triangle containing the query point by walking the mesh.") | <code>Triangulation_hierarchy_2<wbr>::locate</code> |
...
| Segment search build | 1.1× (0.85–1.2) | 1.9× (1.5–2) | [`IntervalTree`](https://gfonsecabr.github.io/pgl/classpgl_1_1IntervalTree.html "Mutable interval tree over the projection of bounded shapes.") | `AABB_tree` |
...
- **A pgl win over a specialized structure is usually specialization.** pgl's [`ShapeTree`](https://gfonsecabr.github.io/pgl/classpgl_1_1ShapeTree.html "Static shape tree of bounded shapes.") is a 2D `int` tree; CGAL's `Kd_tree` is dimension-generic over an arbitrary kernel, and `AABB_tree` is built for arbitrary primitives in 2D and 3D. They are not attempting the same thing.
