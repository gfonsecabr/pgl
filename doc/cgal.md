...
The results below are sorted by `ERational` / EPECK ratio, from the cases where CGAL is faster to the ones where CGAL is slower. On `ERational` / EPECK ratio the range goes from CGAL being 2.4× faster to pgl being 4.3× faster. On `int` / EPICK, the ratio goes from CGAL being 2.0× faster to pgl being 4.8× faster.

| Problem | `ERational` / EPECK | `int` / EPICK | pgl | CGAL |
| --- | --- | --- | --- | --- |
| Delaunay triangulation | ${\color{#8b0000}\textsf{2.4×}}\textsf{ (2.2–2.8)}$ | ${\color{#8b0000}\textsf{1.6×}}\textsf{ (1.5–1.7)}$ | [`Triangulation`](https://gfonsecabr.github.io/pgl/structpgl_1_1Triangulation.html "Triangulation whose connectivity may change and whose vertex set may grow.") | `Delaunay_triangulation_2` |
...
| Triangulation point location | ${\color{#8b0000}\textsf{1.9×}}\textsf{ (1.7–2.2)}$ | $\textsf{0.97×}\textsf{ (0.87–1.2)}$ | [`t.locate(p)`](https://gfonsecabr.github.io/pgl/structpgl_1_1Triangulation.html#a29b96c32ebb52fddc7fd10eaeee4dbd8 "Finds the triangle containing the query point by walking the mesh.") | <code>Triangulation_hierarchy_2<wbr>::locate</code> |
| Convex hull | ${\color{#8b0000}\textsf{1.7×}}\textsf{ (1.6–1.9)}$ | ${\color{#006400}\textsf{0.47×}}\textsf{ (0.40–0.55)}$ | [`convexHull(v)`](https://gfonsecabr.github.io/pgl/namespacepgl.html#a3999bfdf73609b7ec708a4882fcaea2f "Computes the convex hull of a point container.") | `convex_hull_2` |
...
| kd-tree build | $\textsf{0.93×}\textsf{ (0.86–0.99)}$ | ${\color{#8b0000}\textsf{2.0×}}\textsf{ (1.9–2.3)}$ | [`ShapeTree`](https://gfonsecabr.github.io/pgl/classpgl_1_1ShapeTree.html "Static shape tree of bounded shapes.") | `Kd_tree` |
...
| Nearest neighbor query | ${\color{#006400}\textsf{0.64×}}\textsf{ (0.60–0.72)}$ | ${\color{#8b0000}\textsf{1.5×}}\textsf{ (1.2–1.6)}$ | [`t.nearestNeighbor(p)`](https://gfonsecabr.github.io/pgl/classpgl_1_1ShapeTree.html#ab474ac9db17611ead980ea1ff63f3446 "Returns the stored shape nearest to a query shape.") | <code>Orthogonal_k_<wbr>neighbor_search</code> |
