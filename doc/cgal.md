...
| Segment intersection | ${\color{#8b0000}\textsf{1.9×}}\textsf{ (1.3–3.0)}$ | $\textsf{1.2×}\textsf{ (0.93–1.4)}$\* | [`findIntersections(v)`](https://gfonsecabr.github.io/pgl/namespacepgl.html#adcd493466342b027a48fe7bf0718434b "Finds all intersecting segment pairs with Bentley-Ottmann.") | <code>compute_<wbr>intersection_points</code> |
