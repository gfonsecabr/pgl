...
- **Order-$k$ Voronoi and power diagrams.** [`voronoiDiagram`](https://gfonsecabr.github.io/pgl/namespacepgl.html#a6cc9b13abeb83be524eebae5c690fe2a "Computes the Voronoi diagram of a set of points.") and [`powerDiagram`](https://gfonsecabr.github.io/pgl/namespacepgl.html#acdaa70fea88f1688d348bf191da38f13 "Computes the power diagram of a set of disks.") take the order as an argument and label each face with the $k$ sites that own it. CGAL's `Voronoi_diagram_2` is an adaptor over a triangulation's dual, which is the order-1 case only.
