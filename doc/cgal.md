...
The results below are sorted by `ERational` / EPECK ratio, from the cases where CGAL is faster to the ones where CGAL is slower. On `ERational` / EPECK ratio the range goes from CGAL being 2.7× faster to pgl being 4.3× faster. On `int` / EPICK, the ratio goes from CGAL being 1.9× faster to pgl being 4.6× faster.
...
| Point search, count in Triangle | ${\color{#8b0000}\textsf{2.4×}}\textsf{ (1.5–3.0)}$ | ${\color{#006400}\textsf{0.23×}}\textsf{ (0.15–0.29)}$ | [`ShapeTree`](https://gfonsecabr.github.io/pgl/classpgl_1_1ShapeTree.html "Shape tree of bounded shapes.") | `Kd_tree::search` |
| Convex hull | ${\color{#8b0000}\textsf{1.8×}}\textsf{ (1.5–2.2)}$ | ${\color{#006400}\textsf{0.51×}}\textsf{ (0.40–0.69)}$ | [`convexHull(v)`](https://gfonsecabr.github.io/pgl/namespacepgl.html#a3999bfdf73609b7ec708a4882fcaea2f "Computes the convex hull of a point container.") | `convex_hull_2` |
| Triangulation point location | ${\color{#8b0000}\textsf{1.7×}}\textsf{ (1.5–2.7)}$ | $\textsf{0.95×}\textsf{ (0.76–1.2)}$ | [`t.locate(p)`](https://gfonsecabr.github.io/pgl/structpgl_1_1Triangulation.html#a29b96c32ebb52fddc7fd10eaeee4dbd8 "Finds the triangle containing the query point by walking the mesh.") | <code>Triangulation_hierarchy_2<wbr>::locate</code> |
...
| Segment intersection | ${\color{#006400}\textsf{0.58×}}\textsf{ (0.23–1.8)}$ | ${\color{#006400}\textsf{0.36×}}\textsf{ (0.12–0.66)}$\* | [`findIntersections(v)`](https://gfonsecabr.github.io/pgl/namespacepgl.html#adcd493466342b027a48fe7bf0718434b "Finds all intersecting segment pairs.") | <code>compute_<wbr>intersection_points</code> |
| Minkowski sum | ${\color{#006400}\textsf{0.52×}}\textsf{ (0.25–0.80)}$† | — | [`a.minkowskiSum(b)`](https://gfonsecabr.github.io/pgl/structpgl_1_1Polygon.html#afe1664a4092da89cf4055a68eedf08ab "Returns the regularized Minkowski sum of the two shapes (A ⊕ B).") | `minkowski_sum_2` |
| Arrangement point location query | ${\color{#006400}\textsf{0.46×}}\textsf{ (0.30–0.82)}$ | — | [`a.locateFace(p)`](https://gfonsecabr.github.io/pgl/classpgl_1_1Arrangement.html#a95d36d4248271458151cc640bf838704 "Returns the face containing a point.") | <code>Arr_trapezoid_ric_<wbr>point_location<wbr>::locate</code> |
| Regularized union, triangles | ${\color{#006400}\textsf{0.23×}}\textsf{ (0.21–0.61)}$ | — | [`regularizedUnionOf(v)`](https://gfonsecabr.github.io/pgl/namespacepgl.html#ae72efa38504e74942758d2d4fb78ffcd "The regularized union of arbitrarily many shapes, as a set of regions.") | <code>General_polygon_set_2<wbr>::join</code> |
