...
- [`xyIntersections(V)`](https://gfonsecabr.github.io/pgl/namespacepgl.html#a1ec3bb3bee9539ead060587b56dddd0d "Finds all intersecting segment pairs with a bounding-box sweep.") returns all intersecting pairs of segments from the container `V`, exactly as [`bruteForceIntersections`](https://gfonsecabr.github.io/pgl/namespacepgl.html#a390afa6b90488531f4702bc242322d46 "Finds all intersecting segment pairs by brute force.") does but in the order a sweep meets them. A vertical line sweeps the bounding-box abscissas while an [interval tree](data_structures.md) over the y-extents holds the segments it currently meets, so only the pairs whose bounding boxes overlap are tested. It takes $O((n+k) \log n)$ time where $k$ is the number of such pairs. Unlike [`findIntersections`](https://gfonsecabr.github.io/pgl/namespacepgl.html#adcd493466342b027a48fe7bf0718434b "Finds all intersecting segment pairs with Bentley-Ottmann.") it needs no exact arithmetic and accepts floating-point coordinates.

- [`xyCrossings(V)`](https://gfonsecabr.github.io/pgl/namespacepgl.html#a2d10945f7d5b5c70e96750d4d51ad0e2 "Finds all crossing segment pairs with a bounding-box sweep.") returns all crossing pairs of segments from the container `V`, exactly as [`bruteForceCrossings`](https://gfonsecabr.github.io/pgl/namespacepgl.html#aac3ae3a0e91834aef9525388948417c4 "Finds all crossing segment pairs by brute force.") does but in the order the same bounding-box sweep meets them, in $O((n+k) \log n)$ time where $k$ is the number of pairs of overlapping bounding boxes. It also accepts floating-point coordinates.
