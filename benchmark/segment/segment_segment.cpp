...
int main() {
    ...
    if (pgl_benchmark::numberEnabled("int")) {
        ...
        run<pgl::Point<int>>([](pgl::Segment<pgl::Point<int>> s, pgl::Segment<pgl::Point<int>> t){return s.crosses(t);});
    }

    if (pgl_benchmark::numberEnabled("double")) {
        std::cout << "crosses\t\tdouble\t\t";
        run<pgl::Point<double>>([](pgl::Segment<pgl::Point<double>> s, pgl::Segment<pgl::Point<double>> t){return s.crosses(t);});
    }

    if (pgl_benchmark::numberEnabled("rational")) {
        std::cout << "crosses\t\tRational i64\t";
        run<pgl::Point<pgl::Rational<>>>([](pgl::Segment<pgl::Point<pgl::Rational<>>> s, pgl::Segment<pgl::Point<pgl::Rational<>>> t){return s.crosses(t);});
    }
    ...
    if (pgl_benchmark::numberEnabled("int")) {
        ...
        run<pgl::Point<int>>([](pgl::Segment<pgl::Point<int>> s, pgl::Segment<pgl::Point<int>> t){return s.intersects(t);});
    }

    if (pgl_benchmark::numberEnabled("double")) {
        std::cout << "intersects\tdouble\t\t";
        run<pgl::Point<double>>([](pgl::Segment<pgl::Point<double>> s, pgl::Segment<pgl::Point<double>> t){return s.intersects(t);});
    }

    if (pgl_benchmark::numberEnabled("rational")) {
        std::cout << "intersects\tRational i64\t";
        run<pgl::Point<pgl::Rational<>>>([](pgl::Segment<pgl::Point<pgl::Rational<>>> s, pgl::Segment<pgl::Point<pgl::Rational<>>> t){return s.intersects(t);});
    }
    ...
    if (pgl_benchmark::numberEnabled("int")) {
        ...
        run<pgl::Point<int>>([](pgl::Segment<pgl::Point<int>> s, pgl::Segment<pgl::Point<int>> t){return s.intersection(t);});
    }

    if (pgl_benchmark::numberEnabled("double")) {
        std::cout << "intersection\tdouble\t\t";
        run<pgl::Point<double>>([](pgl::Segment<pgl::Point<double>> s, pgl::Segment<pgl::Point<double>> t){return s.intersection(t);});
    }

    if (pgl_benchmark::numberEnabled("rational")) {
        std::cout << "intersection\tRational i64\t";
        run<pgl::Point<pgl::Rational<>>>([](pgl::Segment<pgl::Point<pgl::Rational<>>> s, pgl::Segment<pgl::Point<pgl::Rational<>>> t){return s.intersection(t);});
    }
    ...
    if (pgl_benchmark::numberEnabled("int")) {
        ...
        run<pgl::Point<int>>([](pgl::Segment<pgl::Point<int>> s, pgl::Segment<pgl::Point<int>> t){return s.separates(t);});
    }

    if (pgl_benchmark::numberEnabled("double")) {
        std::cout << "separates\tdouble\t\t";
        run<pgl::Point<double>>([](pgl::Segment<pgl::Point<double>> s, pgl::Segment<pgl::Point<double>> t){return s.separates(t);});
    }

    if (pgl_benchmark::numberEnabled("rational")) {
        std::cout << "separates\tRational i64\t";
        run<pgl::Point<pgl::Rational<>>>([](pgl::Segment<pgl::Point<pgl::Rational<>>> s, pgl::Segment<pgl::Point<pgl::Rational<>>> t){return s.separates(t);});
    }
    ...
    if (pgl_benchmark::numberEnabled("int")) {
        ...
        run<pgl::Point<int>>([](pgl::Segment<pgl::Point<int>> s, pgl::Segment<pgl::Point<int>> t){return s.interiorsIntersect(t);});
    }

    if (pgl_benchmark::numberEnabled("double")) {
        std::cout << "interiorsIntersect\tdouble\t\t";
        run<pgl::Point<double>>([](pgl::Segment<pgl::Point<double>> s, pgl::Segment<pgl::Point<double>> t){return s.interiorsIntersect(t);});
    }

    if (pgl_benchmark::numberEnabled("rational")) {
        std::cout << "interiorsIntersect\tRational i64\t";
        run<pgl::Point<pgl::Rational<>>>([](pgl::Segment<pgl::Point<pgl::Rational<>>> s, pgl::Segment<pgl::Point<pgl::Rational<>>> t){return s.interiorsIntersect(t);});
    }
    ...
    if (pgl_benchmark::numberEnabled("int")) {
        ...
        run<pgl::Point<int>>([](pgl::Segment<pgl::Point<int>> s, pgl::Segment<pgl::Point<int>> t){return s.contains(t);});
    }

    if (pgl_benchmark::numberEnabled("double")) {
        std::cout << "contains\tdouble\t\t";
        run<pgl::Point<double>>([](pgl::Segment<pgl::Point<double>> s, pgl::Segment<pgl::Point<double>> t){return s.contains(t);});
    }

    if (pgl_benchmark::numberEnabled("rational")) {
        std::cout << "contains\tRational i64\t";
        run<pgl::Point<pgl::Rational<>>>([](pgl::Segment<pgl::Point<pgl::Rational<>>> s, pgl::Segment<pgl::Point<pgl::Rational<>>> t){return s.contains(t);});
    }
