...
template<PointConcept OtherPoint>
constexpr bool Segment<PointType>::interiorsIntersect(const OtherPoint&) const {
    return false;
}

template <class PointType>
template<PointConcept OtherPoint>
constexpr bool Segment<PointType>::interiorsIntersect(const Segment<OtherPoint>& other) const {
...
template <class PointType>
constexpr bool Segment<PointType>::interiorsIntersect(const Shape<PointType>& other) const {
    return std::visit(
