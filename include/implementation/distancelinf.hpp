...
constexpr auto Polygon<PointType_, TLabel>::distanceLInf(const OtherChain& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
constexpr ResultNumber MonotoneChain<PointType, LabelType, Storage>::edgeMinDistanceLInf(const OtherShape& other) const {
    ...
    for (std::size_t index = 1; index + 1 < size(); ++index) {
        const ResultNumber current =
            this->template boundaryAt<false>(index).template distanceLInf<ResultNumber>(other);
        if (current < best) {
            best = current;
        }
    }
...
template <class PointType, class LabelType>
template <class ResultNumber, PointConcept OtherPoint>
constexpr auto Polyline<PointType, LabelType>::distanceLInf(const OtherPoint& point) const {
    if (intersects(point)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(point);
...
template <class PointType, class LabelType>
template <class ResultNumber, SegmentConcept OtherSegment>
constexpr auto Polyline<PointType, LabelType>::distanceLInf(const OtherSegment& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
constexpr auto Polyline<PointType, LabelType>::distanceLInf(const OtherPolyline& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, OrientedSegmentConcept OtherOrientedSegment>
constexpr auto Polyline<PointType, LabelType>::distanceLInf(const OtherOrientedSegment& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, LineConcept OtherLine>
constexpr auto Polyline<PointType, LabelType>::distanceLInf(const OtherLine& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, OrientedLineConcept OtherOrientedLine>
constexpr auto Polyline<PointType, LabelType>::distanceLInf(const OtherOrientedLine& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, RayConcept OtherRay>
constexpr auto Polyline<PointType, LabelType>::distanceLInf(const OtherRay& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, HalfplaneConcept OtherHalfplane>
constexpr auto Polyline<PointType, LabelType>::distanceLInf(const OtherHalfplane& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, RectangleConcept OtherRectangle>
constexpr auto Polyline<PointType, LabelType>::distanceLInf(const OtherRectangle& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, TriangleConcept OtherTriangle>
constexpr auto Polyline<PointType, LabelType>::distanceLInf(const OtherTriangle& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, ConvexConcept OtherConvex>
constexpr auto Polyline<PointType, LabelType>::distanceLInf(const OtherConvex& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, MonotoneChainConcept OtherChain>
constexpr auto Polyline<PointType, LabelType>::distanceLInf(const OtherChain& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
template <class PointType_, class TLabel>
template <class ResultNumber, PolylineConcept OtherPolyline>
constexpr auto Polygon<PointType_, TLabel>::distanceLInf(const OtherPolyline& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, LineConcept OtherLine>
constexpr auto PolygonWithHoles<PointType, LabelType>::distanceLInf(const OtherLine& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, OrientedLineConcept OtherOrientedLine>
constexpr auto PolygonWithHoles<PointType, LabelType>::distanceLInf(const OtherOrientedLine& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, RayConcept OtherRay>
constexpr auto PolygonWithHoles<PointType, LabelType>::distanceLInf(const OtherRay& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, HalfplaneConcept OtherHalfplane>
constexpr auto PolygonWithHoles<PointType, LabelType>::distanceLInf(const OtherHalfplane& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, RectangleConcept OtherRectangle>
constexpr auto PolygonWithHoles<PointType, LabelType>::distanceLInf(const OtherRectangle& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, TriangleConcept OtherTriangle>
constexpr auto PolygonWithHoles<PointType, LabelType>::distanceLInf(const OtherTriangle& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, ConvexConcept OtherConvex>
constexpr auto PolygonWithHoles<PointType, LabelType>::distanceLInf(const OtherConvex& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, PolygonConcept OtherPolygon>
constexpr auto PolygonWithHoles<PointType, LabelType>::distanceLInf(const OtherPolygon& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
constexpr auto PolygonWithHoles<PointType, LabelType>::distanceLInf(const OtherRegion& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, MonotoneChainConcept OtherChain>
constexpr auto PolygonWithHoles<PointType, LabelType>::distanceLInf(const OtherChain& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, PolylineConcept OtherPolyline>
constexpr auto PolygonWithHoles<PointType, LabelType>::distanceLInf(const OtherPolyline& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
constexpr auto PolygonWithHoles<PointType, LabelType>::distanceLInf(const OtherIntersection& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinDistanceLInf<ResultNumber>(other);
...
auto PolygonSet<PointType, LabelType>::distanceLInf(const OtherSet& other) const {
    ResultNumber best{};
    bool seeded = false;
    for (const auto& component : other) {
        const ResultNumber current = this->template distanceLInf<ResultNumber>(component);
        if (!seeded || current < best) {
            best = current;
            seeded = true;
        }
