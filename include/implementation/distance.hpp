...
template <class PointType, class LabelType, class Storage>
template <class ResultNumber, PointConcept OtherPoint>
constexpr auto MonotoneChain<PointType, LabelType, Storage>::squaredDistance(const OtherPoint& point) const {
    if (intersects(point)) {
        return ResultNumber{};
    }
    return this->template edgeMinSquaredDistance<ResultNumber>(point);
...
template <class PointType, class LabelType, class Storage>
template <class ResultNumber, SegmentConcept OtherSegment>
constexpr auto MonotoneChain<PointType, LabelType, Storage>::squaredDistance(const OtherSegment& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinSquaredDistance<ResultNumber>(other);
...
template <class PointType, class LabelType, class Storage>
template <class ResultNumber, OrientedSegmentConcept OtherOrientedSegment>
constexpr auto MonotoneChain<PointType, LabelType, Storage>::squaredDistance(const OtherOrientedSegment& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinSquaredDistance<ResultNumber>(other);
...
template <class PointType, class LabelType, class Storage>
template <class ResultNumber, LineConcept OtherLine>
constexpr auto MonotoneChain<PointType, LabelType, Storage>::squaredDistance(const OtherLine& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinSquaredDistance<ResultNumber>(other);
...
template <class PointType, class LabelType, class Storage>
template <class ResultNumber, OrientedLineConcept OtherOrientedLine>
constexpr auto MonotoneChain<PointType, LabelType, Storage>::squaredDistance(const OtherOrientedLine& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinSquaredDistance<ResultNumber>(other);
...
template <class PointType, class LabelType, class Storage>
template <class ResultNumber, RayConcept OtherRay>
constexpr auto MonotoneChain<PointType, LabelType, Storage>::squaredDistance(const OtherRay& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinSquaredDistance<ResultNumber>(other);
...
template <class PointType, class LabelType, class Storage>
template <class ResultNumber, HalfplaneConcept OtherHalfplane>
constexpr auto MonotoneChain<PointType, LabelType, Storage>::squaredDistance(const OtherHalfplane& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinSquaredDistance<ResultNumber>(other);
...
template <class PointType, class LabelType, class Storage>
template <class ResultNumber, RectangleConcept OtherRectangle>
constexpr auto MonotoneChain<PointType, LabelType, Storage>::squaredDistance(const OtherRectangle& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinSquaredDistance<ResultNumber>(other);
...
template <class PointType, class LabelType, class Storage>
template <class ResultNumber, TriangleConcept OtherTriangle>
constexpr auto MonotoneChain<PointType, LabelType, Storage>::squaredDistance(const OtherTriangle& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinSquaredDistance<ResultNumber>(other);
...
template <class PointType, class LabelType, class Storage>
template <class ResultNumber, ConvexConcept OtherConvex>
constexpr auto MonotoneChain<PointType, LabelType, Storage>::squaredDistance(const OtherConvex& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinSquaredDistance<ResultNumber>(other);
...
template <class PointType, class LabelType, class Storage>
template <class ResultNumber, MonotoneChainConcept OtherChain>
constexpr auto MonotoneChain<PointType, LabelType, Storage>::squaredDistance(const OtherChain& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinSquaredDistance<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, PointConcept OtherPoint>
constexpr auto Polyline<PointType, LabelType>::squaredDistance(const OtherPoint& point) const {
    if (intersects(point)) {
        return ResultNumber{};
    }
    return this->template edgeMinSquaredDistance<ResultNumber>(point);
...
template <class PointType, class LabelType>
template <class ResultNumber, SegmentConcept OtherSegment>
constexpr auto Polyline<PointType, LabelType>::squaredDistance(const OtherSegment& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinSquaredDistance<ResultNumber>(other);
...
constexpr auto Polyline<PointType, LabelType>::squaredDistance(const OtherPolyline& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinSquaredDistance<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, OrientedSegmentConcept OtherOrientedSegment>
constexpr auto Polyline<PointType, LabelType>::squaredDistance(const OtherOrientedSegment& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinSquaredDistance<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, LineConcept OtherLine>
constexpr auto Polyline<PointType, LabelType>::squaredDistance(const OtherLine& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinSquaredDistance<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, OrientedLineConcept OtherOrientedLine>
constexpr auto Polyline<PointType, LabelType>::squaredDistance(const OtherOrientedLine& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinSquaredDistance<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, RayConcept OtherRay>
constexpr auto Polyline<PointType, LabelType>::squaredDistance(const OtherRay& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinSquaredDistance<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, HalfplaneConcept OtherHalfplane>
constexpr auto Polyline<PointType, LabelType>::squaredDistance(const OtherHalfplane& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinSquaredDistance<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, RectangleConcept OtherRectangle>
constexpr auto Polyline<PointType, LabelType>::squaredDistance(const OtherRectangle& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinSquaredDistance<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, TriangleConcept OtherTriangle>
constexpr auto Polyline<PointType, LabelType>::squaredDistance(const OtherTriangle& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinSquaredDistance<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, ConvexConcept OtherConvex>
constexpr auto Polyline<PointType, LabelType>::squaredDistance(const OtherConvex& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinSquaredDistance<ResultNumber>(other);
...
template <class PointType, class LabelType>
template <class ResultNumber, MonotoneChainConcept OtherChain>
constexpr auto Polyline<PointType, LabelType>::squaredDistance(const OtherChain& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinSquaredDistance<ResultNumber>(other);
...
template <class PointType_, class TLabel>
template <class ResultNumber, PolylineConcept OtherPolyline>
constexpr auto Polygon<PointType_, TLabel>::squaredDistance(const OtherPolyline& other) const {
    if (intersects(other)) {
        return ResultNumber{};
    }
    return this->template edgeMinSquaredDistance<ResultNumber>(other);
...
auto PolygonSet<PointType, LabelType>::squaredDistance(const OtherSet& other) const {
    ResultNumber best{};
    bool seeded = false;
    for (const auto& component : other) {
        const ResultNumber current = this->template squaredDistance<ResultNumber>(component);
        if (!seeded || current < best) {
            best = current;
            seeded = true;
        }
