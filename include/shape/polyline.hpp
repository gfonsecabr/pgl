...
struct Polyline {
     ...
     *
     * The point and polyline labels are kept.
     *
     * @tparam Number Coordinate type of the result.
     */
    template <class Number>
    [[nodiscard]] constexpr Polyline<detail::with_number_t<PointType, Number>, LabelType> with() const {
        return Polyline<detail::with_number_t<PointType, Number>, LabelType>(*this);
    }

    /**
     * @brief Returns a copy whose polyline label has type @p Label.
     *
     * The label converts as in a converting construction: it is copied into
     * @p Label, default-constructed when this polyline has none, and dropped when
     * @p Label is @ref NoLabel.
     *
     * @tparam Label Polyline label type of the result.
     */
    template <class Label>
        requires(detail::can_copy_label_v<Label, LabelType>)
    [[nodiscard]] constexpr Polyline<PointType, Label> withLabel() const {
        return Polyline<PointType, Label>(*this);
    }

    /**
     * @brief Returns a copy whose points' labels have type @p Label.
     *
     * Each point label converts as in a converting construction; the polyline
     * label is kept.
     *
    ...
    [[nodiscard]] constexpr Polyline<detail::with_point_label_t<PointType, Label>, LabelType> withPointLabel() const {
        return Polyline<detail::with_point_label_t<PointType, Label>, LabelType>(*this);
    }
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::intersectionTag, Polyline, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::regularizedIntersectionTag, Polyline, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::regularizedUnionTag, Polyline, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::differenceTag, Polyline, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::symmetricDifferenceTag, Polyline, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::squaredDistanceTag, Polyline, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::distanceL1Tag, Polyline, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::distanceLInfTag, Polyline, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::squaredHausdorffDistanceTag, Polyline, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::hausdorffDistanceL1Tag, Polyline, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::hausdorffDistanceLInfTag, Polyline, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::closestPointsTag, Polyline, OtherShape>
    ...
    template <class ResultNumber = NumberType, ShapeConcept OtherShape>
        requires detail::Receives<detail::closestSegmentsTag, Polyline, OtherShape>
     ...
     *
     * The farthest point of the polyline from @p point is one of its vertices, so
    ...
    /**
     * @brief Returns the polyline with vertices removed, within a Hausdorff
     ...
     * coordinate type. Its Hausdorff distance to this polyline is at most the
     ...
     * may self-intersect even where this polyline does not.
     *
     * Complexity: O(n²) for n vertices.
     *
    ...
    [[nodiscard]] Polyline simplified(const Tolerance& squaredTolerance) const;

    /** @brief Replaces the polyline by @ref simplified with the same tolerance. */
    template <class Tolerance>
