...
struct OrientedLine {
     ...
     */
    template <class Number>
    [[nodiscard]] constexpr OrientedLine<detail::with_number_t<PointType, Number>, LabelType> with() const {
        return OrientedLine<detail::with_number_t<PointType, Number>, LabelType>(*this);
    }
    ...
    [[nodiscard]] constexpr OrientedLine<PointType, Label> withLabel() const {
        return OrientedLine<PointType, Label>(*this);
    }
    ...
    [[nodiscard]] constexpr OrientedLine<detail::with_point_label_t<PointType, Label>, LabelType> withPointLabel() const {
        return OrientedLine<detail::with_point_label_t<PointType, Label>, LabelType>(*this);
    }
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::intersectionTag, OrientedLine, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::regularizedIntersectionTag, OrientedLine, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::regularizedUnionTag, OrientedLine, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::differenceTag, OrientedLine, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::symmetricDifferenceTag, OrientedLine, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::squaredDistanceTag, OrientedLine, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::distanceL1Tag, OrientedLine, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::distanceLInfTag, OrientedLine, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::squaredHausdorffDistanceTag, OrientedLine, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::hausdorffDistanceL1Tag, OrientedLine, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::hausdorffDistanceLInfTag, OrientedLine, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::closestPointsTag, OrientedLine, OtherShape>
    ...
    template <class ResultNumber = NumberType, ShapeConcept OtherShape>
        requires detail::Receives<detail::closestSegmentsTag, OrientedLine, OtherShape>
    ...
    /** @brief Tests whether this shape is parallel to the shape @p other holds. */
    template <ShapeConcept OtherShape>
    [[nodiscard]] constexpr bool parallel(const OtherShape& other) const {
        return detail::parallelAny(*this, other);
    }
    /** @brief Tests whether this shape is collinear with the shape @p other holds. */
    template <ShapeConcept OtherShape>
    [[nodiscard]] constexpr bool collinear(const OtherShape& other) const {
        return detail::collinearAny(*this, other);
    }
    /** @brief Returns which side of this shape the point @p other holds lies on. */
    template <ShapeConcept OtherShape>
    [[nodiscard]] constexpr std::partial_ordering orientation(const OtherShape& other) const {
    ...
    // member aliases, and matched token for token by the out-of-class
    // definition in transformations.hpp: MSVC matches a definition whose return
    // type reaches through a parameter for a nested type by spelling rather
    // than by parameter position, and rejects any other name with C2244.
