...
struct Rectangle {
     ...
     *
     * The point and rectangle labels are kept.
     *
     * @tparam Number Coordinate type of the result.
     */
    template <class Number>
    [[nodiscard]] constexpr Rectangle<detail::with_number_t<PointType, Number>, LabelType> with() const {
        return Rectangle<detail::with_number_t<PointType, Number>, LabelType>(*this);
    }

    /**
     * @brief Returns a copy whose rectangle label has type @p Label.
     *
     * The label converts as in a converting construction: it is copied into
     * @p Label, default-constructed when this rectangle has none, and dropped when
     * @p Label is @ref NoLabel.
     *
     * @tparam Label Rectangle label type of the result.
     */
    template <class Label>
        requires(detail::can_copy_label_v<Label, LabelType>)
    [[nodiscard]] constexpr Rectangle<PointType, Label> withLabel() const {
        return Rectangle<PointType, Label>(*this);
    }

    /**
     * @brief Returns a copy whose points' labels have type @p Label.
     *
     * Each point label converts as in a converting construction; the rectangle
     * label is kept.
     *
    ...
    [[nodiscard]] constexpr Rectangle<detail::with_point_label_t<PointType, Label>, LabelType> withPointLabel() const {
        return Rectangle<detail::with_point_label_t<PointType, Label>, LabelType>(*this);
    }
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::intersectionTag, Rectangle, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::regularizedIntersectionTag, Rectangle, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::regularizedUnionTag, Rectangle, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::differenceTag, Rectangle, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::symmetricDifferenceTag, Rectangle, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::squaredDistanceTag, Rectangle, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::distanceL1Tag, Rectangle, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::distanceLInfTag, Rectangle, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::squaredHausdorffDistanceTag, Rectangle, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::hausdorffDistanceL1Tag, Rectangle, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::hausdorffDistanceLInfTag, Rectangle, OtherShape>
    ...
    template <class ResultNumber = division_result_t<NumberType>, ShapeConcept OtherShape>
        requires detail::Receives<detail::closestPointsTag, Rectangle, OtherShape>
    ...
    template <class ResultNumber = NumberType, ShapeConcept OtherShape>
        requires detail::Receives<detail::closestSegmentsTag, Rectangle, OtherShape>
    ...
    template <class ApproximateNumber = double, detail::NonConvexPolygonalConcept OtherShape>
        requires requires(const OtherShape& o, const Rectangle& self) {
     ...
     * Two rectangles are the one non-trivial pair closed under the erosion:
     * their minima and their maxima subtract, and the result is empty when a
     * side of the operand is the longer.
     *
     ...
     * other union. See @ref Polygon::regularizedUnion for the contract.
     *
     * @tparam ResultNumber The number type for the result.
     ...
     * hand the pair to the way @ref regularizedUnion does: a rectangle has to state it
     ...
     * operation makes, and one that costs nothing, the four corners already
     ...
     * rectangle owns, being the lowest-ranked of them; every other pair is
     * defined on the higher-ranked operand and reached through the forwarding
     * overload below. See @ref Polygon::symmetricDifference for the contract.
     *
     * @tparam ResultNumber The number type for the result.
